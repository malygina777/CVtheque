        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <p className="text-sm text-muted-foreground">
              1) Choisis un domaine, 2) Gère les associations.
            </p>
          </div>
              ...
              {domains.map((d) => (
                <li key={d.id}>
                  <button
                    ...
                    className={[
                      "w-full rounded-md px-3 py-2 text-left text-sm hover:!bg-lime-200 hover:!scale-[1.04] hover:!text-black transition-all duration-150 cursor-pointer",
                      "min-w-0",
